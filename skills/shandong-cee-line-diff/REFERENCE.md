...
- `direction_subset(a,b)`：a 某方向括号内容含/被含 b 某方向 = 拆括号/子串同一（图灵班↔图灵班(智算/智能可信)、
  金融学↔金融学(两方向)）。**仅作 agent 候选提示，不自动匹配**——大类专业第二括号是「专业清单」(计算机/软件工程…)，
  宽松子串会假匹配（反例：北航量子科技先锋计划近三年无量子却被专业清单子串误判）。
- `bare_to_direction`：候选恰 1 条且无方向括号(bare) → 2026 任何方向都匹配该候选（去年 1 bare→今年多方向=同一批，
  法学/金融学规则）。
- **同义**（数智↔数字、航天↔宇航、智能语言↔语言智能已属词序）非字面可判 → 交 agent 语义，不进自动匹配。
...
- **大类重组待人工复核**：核心名为试验班/XX类，2026 与近三年双方均多具体班级且无唯一对应 → 留特殊情况待人工（不强估不强配；用户定）。
...
日志/备注须用用户能懂的中文，**禁**「候选/裸名/D/属性/核心对齐/未归类/身份标识」等术语。映射：

| 情形 | 人话（写这个） | 禁（黑话） |
|------|------|------|
| 近三年无此方向可比 | 近三年没有这个专业方向 | 候选为空/无法核实/核心未对齐 |
| 2026 标方向、近三年没标 | 大绿本标了方向，近三年没标 | D带方向候选裸名/候选裸核心名 |
| 无任何匹配 | 没找到能匹配的近三年专业 | 剩余未归类 |
| 2026 标招生类别、近三年没 | 大绿本标了招生类别（如综合评价），近三年没有 | 含身份标识候选无 |
| 2026 标班级、近三年没 | 大绿本标了班级（如卓越班/创新班），近三年没有 | 班级身份不一致/带创新班候选裸名 |
| 合作方式不同 | 中外合作/校企合作的合作方式不同 | 合作属性不一致/联合双学位属性不一致 |
| 2026 标校区、近三年没 | 大绿本标了校区，近三年没标 | 大绿本带校区候选无 |
| 大类重组无对应 | 2026 和近三年的试验班/大类具体方向都对不上，需人工核对 | 各类「不一致/未对齐」黑话 |
| 改名（新↔旧） | 已更名为 X（原 Y），按改名匹配 | is_rename/疑似改名校(见改名表) |
